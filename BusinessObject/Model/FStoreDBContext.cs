    ...
    public partial class FStoreDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //                optionsBuilder.UseSqlServer("server=(local);database=FStoreDB;uid=sa;pwd=123456;TrustServerCertificate=True");
        ...
        private string GetConnectionString()
        {
            var build = new ConfigurationBuilder()
                ...
                .Build();
            return build["ConnectionStrings:FStoreDB"];
        }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ProductId })
                    .HasName("PK__OrderDet__08D097A3BE58AEAF");
